    ...
    for letter in letter_files:
        ...
        for label in labels:
            ...
            for f in images:
                ...
                num_files += 1
    with open ("/home/yaatehr/programs/spatial_LDA/data/top25_sift/VAL_predicted_%s_topics_%s_keypoints_%s_clusters.pkl" %(n_topics, n_keypoints, n_clusters), "wb") as f:
        pickle.dump(predicted_cluster_dic, f)
    with open("/home/yaatehr/programs/spatial_LDA/data/top25_sift/VAL_clustered_images_%s_topics_%s_keypoints_%s_clusters.pkl" %(n_topics, n_keypoints, n_clusters), "wb") as f:
        pickle.dump(cluster_dic_validation, f)
    with open("/home/yaatehr/programs/spatial_LDA/data/top25_sift/VAL_prob_distrs_%s_topics_%s_keypoints_%s_clusters.pkl" %(n_topics, n_keypoints, n_clusters), "wb") as f:
